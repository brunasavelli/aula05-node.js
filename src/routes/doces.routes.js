...
docesRoutes.get("/:id", (req, res) => {
    ...
    const guloseima = guloseimas.find((doces) => 
        doces.id === Number(id)
    );
...
docesRoutes.put("/:id", (req, res) => {
    ...
    const guloseima = guloseimas.find((doces) => doces.id === Number(id));
...
docesRoutes.delete("/:id", (req, res) => {
    ...
    guloseimas = guloseimas.filter((doces) => doces.id !== Number(id));
